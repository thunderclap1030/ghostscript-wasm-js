...
#define ARCH_ALIGN_UINT64_T_MOD 8     /* REQUIRED for GS10+ */
...
#define ARCH_LOG2_SIZEOF_UINT64_T 3   /* REQUIRED */

#define ARCH_SIZEOF_SIZE_T 4
#define ARCH_SIZEOF_PTR 4
#define ARCH_SIZEOF_FLOAT 4
#define ARCH_SIZEOF_DOUBLE 8
#define ARCH_SIZEOF_UINT64_T 8        /* REQUIRED */
...
#define ARCH_MAX_SIZE_T ((size_t)~0U)
#define ARCH_MAX_UINT64_T ((uint64_t)~0ULL)   /* REQUIRED */
